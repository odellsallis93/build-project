...
namespace UnityEngine.XR.ARFoundation.Samples
{
          ...
          public class TrackedImageInfoManager : MonoBehaviour
          {
                    ...
                    void UpdateInfo(ARTrackedImage trackedImage)
                    {
                              ...
                              var videoPlayer = canvas.GetComponentInChildren<VideoPlayer>();
                              ...
                              {
                                        // Set the plane color to white
                                        var planeGo = trackedImage.transform.GetChild(0).gameObject;
                                        var material = planeGo.GetComponentInChildren<MeshRenderer>().material;
                                        material.color = Color.white; // Set the plane color to white

                                        // Set the text to black and update its content
                                        text.color = Color.white;
                                        text.text = "Trying to deploy before the deadline like\n";

                                        // Set the video player to play the desired video
                              ...
                              else
                              {
                                            ...
                                            trackedImage.size * 100f);
                                        {
                                                  ...
                                                  if (trackedImage.trackingState != TrackingState.None)
                                                  {
                                                            ...
                                                            // Set the texture 
                                                            material = planeGo.GetComponentInChildren<MeshRenderer>().material;
